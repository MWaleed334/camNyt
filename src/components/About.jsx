...
const About = () => {
    return (
        ...
        <div className=''>
            ...
            <div>
                <section className='bg-white max-w-screen-2xl mx-auto lg:px-16 md:px-10 sm:px-6 px-4 py-16 flex lg:flex-row flex-col  justify-around mb-10 '>
                    <div className='lg:w-[50%] w-full flex flex-col md:gap-2 gap-6 lg:mt-23 xl:mt-23 items-center sm:items-start'>
                        ...
                        <Image src={arrowShape} className='w-[20%] lg:w-[30%] mt-[-30px] lg:ml-[550px] flex justify-end md:ml-0 ml-[237px]' />
            ...
            <div>
                <section className='bg-[#212121]  lg:h-[70vh] md:h-[97vh] sm:h-[80vh] max-w-screen-2xl mx-auto lg:px-16 md:px-10 sm:px-6 px-4 py-16 flex lg:flex-row flex-col gap-6 justify-between items-center '>
                    <div className='lg:w-[43%] flex lg:justify-center md:justify-center justify-center md:w-[86%] w-[61%] lg:ml-[25px]'>
                        <Image
                            src={multipleImage}
                            className='hidden sm:block w-[200px] md:w-[267px] md:h-[428px] lg:w-[85%] lg:h-[670px] lg:relative lg:bottom-[11px]'
                        />

                    </div>
                    <div className='lg:w-[60%] lg:mt-10 md sm:pb-20 w-full flex flex-col md:gap-4 gap-6 text-white padding-[10px] md:mt-[-25px] mt-[23px]  '>
            ...
            <section className='mt-[99px] max-w-[1100px] mx-auto mb-20'>
                ...
                <div className="bg-cover bg-center relative h-1/2 md:h-3/4 lg:h-[42vh]" style={{
                    backgroundImage: `url(/public/images/pink.png)`,  
